...
namespace Serilog
{
    ...
    public static class RawFileLoggerConfigurationExtensions
    {
        ...
        /// Ignored if <paramref see="rollingInterval"/> is <see cref="RawFileRollingInterval.Infinite"/>.
        /// The default is to retain files indefinitely.</param>
        /// <param name="keepFileOpen">If <c>false</c>, file will be closed between writes.</param>
        ...
        public static LoggerConfiguration RawFile(
            ...
            RawFileRollingInterval rollingInterval = RawFileRollingInterval.Infinite,
            bool rollOnFileSizeLimit = false,
            int? retainedFileCountLimit = null,
            RawFileLifecycleHooks? hooks = null,
        ...
        /// overload of <see cref="RawFile(LoggerSinkConfiguration, string, LogEventLevel, string, IFormatProvider, long?, LoggingLevelSwitch, bool, TimeSpan?, RawFileRollingInterval, bool, int?, RawFileLifecycleHooks, TimeSpan?, bool)"/>
            ...
            bool keepFileOpen = true)
        {
            ...
            return ConfigureFile(sinkConfiguration.Sink, formatter, path, restrictedToMinimumLevel, fileSizeLimitBytes, levelSwitch,
                buffered, false, flushToDiskInterval, rollingInterval, rollOnFileSizeLimit,
                retainedFileCountLimit, hooks, retainedFileTimeLimit, keepFileOpen, true);
        }
        ...
        /// <param name="formatter">A formatter, such as <see cref="JsonFormatter"/>, to convert the log events into
        /// text for the file. If control of regular text formatting is required, use the other
        /// overload of <see cref="RawFile(LoggerAuditSinkConfiguration, string, LogEventLevel, string, IFormatProvider, LoggingLevelSwitch, RawFileLifecycleHooks)"/>
        /// and specify the outputTemplate parameter instead.
        /// </param>
        /// <param name="path">Path to the file.</param>
        /// <param name="restrictedToMinimumLevel">The minimum level for
            ...
            RawFileLifecycleHooks? hooks = null)
        {
            ...
            return ConfigureFile(sinkConfiguration.Sink, formatter, path, restrictedToMinimumLevel, null, levelSwitch, false, true,
                null, RawFileRollingInterval.Infinite, false, null, hooks, null, true, false);
        }
        ...
        static LoggerConfiguration ConfigureFile(
            ...
            bool keepFileOpen,
            bool suspendLoggingOnExceptions)
        {
            ...
            if (!keepFileOpen && hooks is not null) throw new ArgumentException($"{nameof(keepFileOpen)} should be true to use {nameof(hooks)}", nameof(keepFileOpen));

            ILogEventSink sink;

            try
            {
                if (rollOnFileSizeLimit || rollingInterval != RawFileRollingInterval.Infinite)
                {
                    sink = new RollingFileSink(path, formatter, fileSizeLimitBytes, retainedFileCountLimit, buffered, rollingInterval, rollOnFileSizeLimit, hooks, retainedFileTimeLimit, keepFileOpen, suspendLoggingOnExceptions);
                }
                else
                {
                    sink = new FileSink(path, formatter, fileSizeLimitBytes, buffered, hooks, keepFileOpen, suspendLoggingOnExceptions);
