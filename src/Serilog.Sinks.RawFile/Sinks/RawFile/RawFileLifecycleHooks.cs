...
namespace Serilog.Sinks.RawFile
{
    ...
    /// </summary>
    public abstract class RawFileLifecycleHooks
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a chain of <see cref="RawFileLifecycleHooks"/> that have their methods called sequentially
        /// Can be used to compose <see cref="RawFileLifecycleHooks"/> together; e.g. add header information to each log file and
        /// compress it.
        /// </summary>
        /// <example>
        /// <code>
        ...
        /// </code>
        /// </example>
        /// <param name="next">The next <see cref="RawFileLifecycleHooks"/> to have its methods called in the chain</param>
        /// <returns></returns>
        public RawFileLifecycleHooks Then(RawFileLifecycleHooks next)
        {
